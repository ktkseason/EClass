...
export default function Card({ course }) {
    ...
    return (
        <Box
            ...
            height="100%"
        >
            <Typography noWrap variant="h5" color={colors.secondary.light} fontWeight="bold">{course.title}</Typography>
            <Typography fontWeight="bold" fontSize="12px" color={colors.secondary.main}>{course.level}</Typography>
